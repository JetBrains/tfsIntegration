...
final class XmlConstants {
  ...
  @NonNls public static final String OWNER_ALIASES = "OwnerAliases";
  @NonNls public static final String OWNER_ALIAS = "OwnerAlias";

  @NonNls public static final String NAME_ATTR = "name";
  @NonNls public static final String OWNER_NAME_ATTR = "ownerName";
  @NonNls public static final String OWNER_DISPLAY_NAME_ATTR = "ownerDisplayName";
  @NonNls public static final String COMPUTER_ATTR = "computer";
  @NonNls public static final String COMMENT_ATTR = "comment";
  @NonNls public static final String IS_LOCAL_WORKSPACE_ATTR = "isLocalWorkspace";
  @NonNls public static final String OWNER_ALIAS_ATTR = "OwnerAlias";
  @NonNls public static final String OPTIONS_ATTR = "options";
  @NonNls public static final String SECURITY_TOKEN_ATTR = "securityToken";
