...
public class DeletedFileInDeleted extends ParentChildChangeTestCase {
  ...
  protected Change getPendingChildChange(ParentChangeState parentChangeState) throws VcsException {
    return parentChangeState == ParentChangeState.NotDone ? getChanges().getDeleteChange(myChildFile) : null;
  }
