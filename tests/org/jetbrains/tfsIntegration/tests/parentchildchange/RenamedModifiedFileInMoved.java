...
public class RenamedModifiedFileInMoved extends ParentChildChangeTestCase {
  ...
  protected void makeChildChange(ParentChangeState parentChangeState) throws VcsException, IOException {
    ...
    final FilePath renamedFile =
      parentChangeState == ParentChangeState.NotDone ? myChildRenamedInParentOriginal : myChildRenamedInParentMoved;
